...
#define AGDATA(obj)		(((Agobj_t*)(obj))->data)
	...
	struct Agiddisc_s {		/* object ID allocator */
		...
		long(*map) (void *state, int objtype, char *str,
			...
			long *id,
			int createflag);
		uintptr_t(*alloc) (void *state, int objtype, uintptr_t id);
		void(*free) (void *state, int objtype, uintptr_t id);
		char *(*print) (void *state, int objtype, uintptr_t id);
		void(*close) (void *state);
...
#   endif
	...
	extern Agnode_t *agidnode(Agraph_t * g, uintptr_t id, int createflag);
	...
	extern Agraph_t *agidsubg(Agraph_t * g, uintptr_t id, int cflag);	/* constructor */
